...
class Image:
    ...
    def create_ps(self):
        ...
        for i in range(0,len(self.lines)):
            color = self.lines[i][0].rgb() #rgb color of line
            addplots_string += "\definecolor{color" + str(i) + "}{RGB}{" + str(color[2]) +"," + str(color[1]) + "," + str(color[0]) + "}"#declaring rgb color
        ...
        os.system('pdf2ps generate.pdf generate.ps')
        os.system('rm generate.pdf')
        os.system('mv generate.ps ' + self.path + ".ps")
