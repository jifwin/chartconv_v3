...
parser.add_argument("--legend_area",default=0.3) #legend - diagonals and lines tolerance
...
parser.add_argument("--lines_merge",default=10) #percentage - legend lines merging
parser.add_argument("--border_thr",default=10) #n-times larger then border remove
